  ...
  <template>
      <section class="m-10">
          ...
          <div class="m-5">
              ...
              <div>
                  <p class="">
                    L'édition du Site est assurée par Stud+ SARL au capital de 6000 euros, immatriculée au Registre du Commerce et des Sociétés de Montbéliard sous le numéro XXXXXXXXX dont le siège social est situé au 2 Rue Apagnan, 25200 Montbéliard,
                    Numéro de téléphone : XXXXXXXXXX
                    Adresse e-mail : studplus@gmail.com N° de TVA intracommunautaire : XXXXXXXXXX
                    Le Directeur de la publication est Tony MORETTI ci-après l'"Editeur".                  
                  </p>
              </div>
          </div>
          <div class="m-5">
              ...
              <div>
                  <p class="pb-5">
                    L'hébergeur du Site est la société Infomaniak, dont le siège social est situé à Genève.                  
                  </p>
              </div>
          </div>
          <div class="m-5">
          ...
          <div class="m-5">
              ...
              <div>
                  ...
                  <ul class="pb-5 list-disc">
                      <li>
                        par mail à l'adresse email contact@studplus.com                    
                      </li>
                      <li>
