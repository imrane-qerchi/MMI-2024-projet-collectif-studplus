...
<template>
  <section class="m-10">
    <div class="relative flex justify-between items-center w-full">
      <h1 class="text-[34px] border-b-2 pb-3 border-[#694C9B]">Politique de confidentialité</h1>
    </div>
    <div class="m-5">
      <h2 class="mb-5 mt-10">I. Préambule</h2>
      <div>
        <p class="pb-5">
        ...
        <ul class="pb-5 list-disc">
          <li>
            Sur la manière dont sont collectées leurs données personnelles. Sont considérées comme
            des données personnelles, toute information permettant d’identifier un utilisateur. A ce
            titre, il peut s’agir : de ses noms et prénoms, de son âge, de son adresse postale ou
            email, de sa localisation ou encore de son adresse IP (liste non-exhaustive) ;
          </li>
    ...
    <div class="m-5">
      ...
      <div>
        ...
        <ul class="pb-5 list-disc">
          ...
          <li>
            Traitées de façon à garantir une sécurité appropriée des données collectées, y compris
            la protection contre le traitement non autorisé ou illicite et contre la perte, la
    ...
    <div class="m-5">
      <h2 class="mb-5 mt-10">
        III. Données à caractère personnel collectées et traitées dans le cadre de la navigation sur
        le site
      </h2>
      <div>
        <p class="pb-5">
    ...
    <div class="m-5">
      <h2 class="mb-5 mt-10">Article 3.1 - Données collectées</h2>
      <div>
        <p class="pb-5">
        ...
        <ul class="pb-5 list-disc">
          ...
          <li>Revente de données.</li>
        </ul>
      </div>
    </div>
    <div class="m-5">
      <h2 class="mb-5 mt-10">Article 3.2 - Mode de collecte des données</h2>
      <p class="pb-5">
        Lorsque vous utilisez notre site, sont automatiquement collectées les données suivantes :
      </p>
      <p class="pb-5">
        D’autres données personnelles sont collectées lorsque vous effectuez les opérations
        suivantes sur la plateforme :
      </p>
      <p class="pb-5">
        Elles sont conservées par le responsable du traitement dans des conditions raisonnables de
        sécurité, pour une durée de 3 ans.
      </p>
      <p class="pb-5">
    ...
    <div class="m-5">
      <h2 class="mb-5 mt-10">Article 3.3 - Hébergement des données</h2>
      <p class="pb-5">
        Le site Stud+ est hébergé par : <br />
        Stud+ <br />
        2 Rue Apagnan, 25200 Montbéliard <br />
        contact@studplus.fr <br />
        XXXXXXXXXX
      </p>
    </div>
    <div class="m-5">
      <h2 class="mb-5 mt-10">
        IV. Responsable du traitement des données et délégué à la protection des données
      </h2>
      <h2 class="mb-5 mt-10">Article 4.1 - Le responsable du traitement des données</h2>
      <p class="pb-5">
        Les données à caractère personnelles sont collectées par Stud+, SARL au capital de 6000€,
        dont le numéro d’immatriculation est le XXXXXXXXX.
      </p>
      <p class="pb-5">
    ...
    <div class="m-5">
      <h2 class="mb-5 mt-10">Article 4.2 - Le délégué à la protection des données</h2>
      <p class="pb-5">
    ...
    <div class="m-5">
      <h2 class="mb-5 mt-10">
        V. Les droits de l’utilisateur en matière de collecte et de traitement des données
      </h2>
      <p class="pb-5">
        Tout utilisateur concerné par le traitement de ses données personnelles peut se prévaloir
        des droits suivants, en application du règlement européen 2016/679 et de la Loi Informatique
        et Liberté (Loi 78-17 du 6 janvier 1978) :
      </p>
      <ul class="pb-5 list-disc">
        <li>
        ...
        <li>
          Droit de ne pas faire l’objet d’une décision fondée exclusivement sur un procédé
          automatisé ;
        </li>
      ...
      <p class="pb-5">
        Pour exercer vos droits, veuillez adresser votre courrier à Stud+ au 2 Rue Apagnan, 25200
        Montbléiard ou par mail à contact@studplus.fr.
      </p>
      <p class="pb-5">
        ...
        et prénoms, son adresse e-mail ainsi que son numéro de compte, d’espace personnel ou
        d’abonné.  Consultez le site cnil.fr pour plus d’informations sur vos droits.
      </p>
    </div>
    <div class="m-5">
      <h2 class="mb-5 mt-10">VI. Conditions de modification de la politique de confidentialité</h2>
      <p class="pb-5">
        L’éditeur du site Stud+ se réserve le droit de pouvoir modifier la présente Politique à tout
        moment afin d’assurer aux utilisateurs du site sa conformité avec le droit en vigueur.
      </p>
      <p class="pb-5">
        Les éventuelles modifications ne sauraient avoir d’incidence sur les achats antérieurement
        effectués sur le site, lesquels restent soumis à la Politique en vigueur au moment de
        l’achat et telle qu’acceptée par l’utilisateur lors de la validation de l’achat.
      </p>
      <p class="pb-5">
        L’utilisateur est invité à prendre connaissance de cette Politique à chaque fois qu’il
        utilise nos services, sans qu’il soit nécessaire de l’en prévenir formellement. 
      </p>
      <p class="pb-5">La présente politique a été éditée le 12/03/2024.</p>
    </div>
  </section>
</template>
