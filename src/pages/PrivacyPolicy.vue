...
<template>
    <section>
        ...
        <div>
            ...
            <div>
                <p>
                    Les données personnelles collectées dans le cadre de notre activité sont les suivantes :                </p>
                <ul>
                    <li>
                        Prénom ;                    
                    </li>
        ...
        <div>
            ...
            <p>
                Les données à caractère personnelles sont collectées par Stud+, SARL au capital de 6000€, dont le numéro d’immatriculation est le XXXXXXXXX.
            </p>
            <p>
        ...
        <div>
            ...
            <p>
                Pour exercer vos droits, veuillez adresser votre courrier à Stud+ au 2 Rue Apagnan, 25200 Montbléiard ou par mail à contact@studplus.fr.
            </p>
            <p>
        ...
        <div>
            <h2>
                VI. Conditions de modification de la politique de confidentialité
            </h2>
            <p>
                L’éditeur du site Stud+ se réserve le droit de pouvoir modifier la présente Politique à tout moment afin d’assurer aux utilisateurs du site sa conformité avec le droit en vigueur.
            </p>
            <p>
            ...
            <p>
                La présente politique a été éditée le 12/03/2024.
            </p>
        </div>
    </section>
</template>