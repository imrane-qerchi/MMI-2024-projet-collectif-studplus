...
<template>
    <section class="m-10">
        ...
        <div class="m-5">
            ...
            <div>
                <p class="pb-5">
                  Les présentes CGU ou Conditions Générales d’Utilisation encadrent juridiquement l’utilisation des services du site Stud+.
                </p>
                <p>
                  Constituant le contrat entre la société Stud+, l’Utilisateur, l’accès au site doit être précédé de l’acceptation de ces CGU. L’accès à cette plateforme signifie l’acceptation des présentes CGU.                
                </p>
            </div>
        </div>
        <div class="m-5">
            ...
            <div>
                <p class="pb-5">
                  L’édition du site Stud+ est assurée par la société Stud+ inscrite au RCS sous le numéro XXX XXX XXX, dont le siège social est localisé au X Rue Apagnan, 25200 Montbéliard .               
                </p>
                <p class="pb-5">
                  L’hébergeur du site est la société Infomaniak, située à Genève, Suisse.
                </p>
            </div>
        </div>
        <div class="m-5">
        ...
        <div class="m-5">
            ...
            <p class="pb-5">
              Les marques, logos ainsi que les contenus du site Stud+ (illustrations graphiques, textes…) sont protégés par le Code de la propriété intellectuelle et par le droit d’auteur.
            </p>
            <p class="pb-5">
        ...
        <div class="m-5">
            ...
            <p class="pb-5">
              L’information présente dans les cookies est utilisée pour améliorer les performances de navigation sur le site Stud+.
            </p>
            <p class="pb-5">
